...
<body>
    ...
    <div id="header">
            ...
            <div id="header_1_right">
                ...
                <c:choose>
                	<c:when test="${ empty sessionScope.loginUser }">
		                <a href="/hyper/enrollform.me">회원가입</a>	<!-- member/enrollform 이렇게 만들고 컨트롤러에서 member컨트롤러에 전체 @RequestMapping(value="member")이렇게 작성해서 사용하면된다. -->
        ...
        <div id="header_2">
            <ul>
                <li><a href="/hyper">HOME</a></li>
                <li><a href="">공지사항</a></li>
                <li><a href="/super/freeBoards">자유게시판</a></li>
    ...
    <div class="modal fade" id="loginModal">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="/super/login.me" method="post">
                    <!-- Modal body -->
